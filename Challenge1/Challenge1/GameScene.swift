...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        // button feacture
        button1 = UIButton()
        button1.frame = CGRect(x: 150 , y: 100, width: 120, height: size.height / 15)
       ...
       //ß button1.transform = CGAffineTransform(rotationAngle: CGFloat.pi / 2)
        ...
        button2 = UIButton()
        button2.frame = CGRect(x: 150 , y: 300 , width: 120, height: size.height / 15)
        ...
        // button for cart
        button3 = UIButton()
        button3.frame = CGRect(x: 150, y: 500, width: 120, height: size.height / 15)
        ...
        // button for cart
        button4 = UIButton()
        button4.frame = CGRect(x: 150, y: 700, width: 120, height: size.height / 15)
